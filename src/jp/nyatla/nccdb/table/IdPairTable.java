...
public abstract class IdPairTable extends BaseTable
{
	...
	class IdPairTableInfo extends BasicTableDefinition
	{
	...
	public IdPairTable(SqliteDB i_db,String i_table_name) throws SdbException
	{
		super(i_db,i_table_name);
		String[] d=this.getIdPairNames();
		try{
	...
	protected boolean add(int i_id1,int i_id2) throws SdbException
	{
		try {
